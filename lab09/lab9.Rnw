...
In this report we reproduce the main results displayed in section 3.1 Simple Linear Regression (chapter 3) of the book An Introduction to Statistical Learning by Gareth James, Daniela Witten, Trevor Hastie and Robert Tibshirani. Here is the link to the book: http://www-bcf.usc.edu/~gareth/ISL/.
...
<<tables1, fig.width=4, fig.height=4, echo = FALSE, results= 'asis'>>=
...
<<tables, fig.width=4, fig.height=4, echo = FALSE, results= 'asis'>>=
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{scatterplot-tv-sales}
